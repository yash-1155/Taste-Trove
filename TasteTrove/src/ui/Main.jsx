        ...
        <div>
          <form className="review-form" onSubmit={handleSubmit}>
            ...
            <div className="rating">
              ...
              />
              <label title="Excellent!" onClick={() => handleStarClick(5)}>
                <svg
              ...
              <label title="Great!" onClick={() => handleStarClick(4)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 576 512"
              ...
              <label title="Good" onClick={() => handleStarClick(3)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 576 512"
              ...
              <label title="Okay" onClick={() => handleStarClick(2)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 576 512"
              ...
              <label title="Bad" onClick={() => handleStarClick(1)}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 576 512"
