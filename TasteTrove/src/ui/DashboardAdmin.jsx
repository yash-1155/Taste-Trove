...
function DashboardAdmin() {
  ...
  const getMonthlySales = () => {
    ...
    const monthlyOrders = orders.filter((order) => {
      ...
      const orderMonth = orderDate.getMonth() + 1; // JavaScript months are zero-based
      return orderMonth === currentMonth;
    });

    // Calculate total sales for the current month
    const monthlySales = monthlyOrders.reduce(
      (total, order) => total + order.order.amount,
      0
    );
  ...
  // Call getMonthlySales to get the total sales for the current month
      ...
      <div id="content">
        ...
        <div id="content_profile">
          {isSettingFormVisible && (
            <div>
              <h1 style={{ fontSize: "30px" }}>Edit You Profile:</h1>
              <div>
              ...
              <br />
              <h1 style={{ fontSize: "20px" }}>Want to Add New Mess?</h1>
              <Button type="small">
